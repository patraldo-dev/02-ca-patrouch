...
INSERT OR IGNORE INTO bottles (id, bottle_type, title, content, content_type, status, launch_lat, launch_lon, current_lat, current_lon, launched_at, is_test, bottle_key) VALUES
...
('phys-malecon-001', 'physical',
 ...
 20.6534, -105.2253, 20.6534, -105.2253, datetime('now'), 0, 'PV-MALECON'),
...
('phys-losmuertos-002', 'physical',
 ...
 'treasure_clue', 'launched',
 20.6440, -105.2270, 20.6440, -105.2270, datetime('now'), 0, 'PV-LOS-MUERTOS'),
...
('phys-cuale-003', 'physical',
 ...
 'treasure_clue', 'launched',
 20.6465, -105.2300, 20.6465, -105.2300, datetime('now'), 0, 'PV-ISLA-CUALE'),
...
('phys-romantica-004', 'physical',
 ...
 'treasure_clue', 'launched',
 20.6380, -105.2240, 20.6380, -105.2240, datetime('now'), 0, 'PV-ROMANTICA'),
...
('phys-olasaltas-005', 'physical',
 ...
 'treasure_clue', 'launched',
 20.6570, -105.2280, 20.6570, -105.2280, datetime('now'), 0, 'PV-OLAS-ALTAS');
