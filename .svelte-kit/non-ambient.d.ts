...
declare module "$app/types" {
	...
	export interface AppTypes {
		...
		Pathname(): "/" | "/admin" | "/admin/analytics" | "/admin/invitations" | "/admin/users" | "/agora" | "/agora/community" | "/api/admin" | "/api/admin/blog" | "/api/admin/books" | `/api/admin/books/${string}` & {} | "/api/admin/cleanup" | "/api/admin/fix-schema" | "/api/admin/invite" | "/api/admin/migrate" | "/api/admin/reviews" | `/api/admin/reviews/${string}` & {} | "/api/admin/update-slugs" | "/api/admin/users" | `/api/admin/users/${string}` & {} | "/api/agora/community" | "/api/agora/leaderboard" | "/api/agora/stats" | "/api/agora/writings" | "/api/analytics" | "/api/auth/forgot-password" | "/api/auth/login" | "/api/auth/logout" | "/api/auth/reset-password" | "/api/auth/signup" | `/api/auth/${string}` & {} | "/api/books" | `/api/books/${string}` & {} | "/api/booty-keywords" | "/api/booty-keywords/propose" | "/api/bottlequest/bets" | "/api/bottlequest/bot-actions" | "/api/bottlequest/bot-ai-cron" | "/api/bottlequest/chat-command" | "/api/bottlequest/chat/ws" | "/api/bottlequest/checkin" | "/api/bottlequest/fuel-request" | "/api/bottlequest/join" | "/api/bottlequest/marketplace" | "/api/bottlequest/move" | "/api/bottlequest/transfer" | "/api/bottles" | "/api/bottles/launch" | "/api/bottles/simulate" | `/api/bottles/${string}` & {} | `/api/comments/${string}` & {} | `/api/comments/${string}/like` & {} | `/api/comments/${string}/pick` & {} | `/api/comments/${string}/report` & {} | "/api/cron" | "/api/debug/books" | "/api/engagement" | "/api/evaluate" | `/api/invite/${string}` & {} | "/api/locale" | "/api/narrator" | "/api/newsletter/send-weekly" | "/api/newsletter/subscribe" | "/api/onboarding" | "/api/profiles" | `/api/profiles/${string}` & {} | `/api/profiles/${string}/switch` & {} | "/api/profile/visibility" | "/api/refine" | "/api/reviews" | "/api/sappho/write" | "/api/search" | "/api/search/index" | "/api/subscribe" | "/api/taller/prompts" | "/api/test-book" | "/api/tts" | "/api/tts/api-key" | "/api/tts/cf-api-key" | "/api/tts/deepinfra-api-key" | "/api/upload-image" | "/api/user/profile" | "/api/write/art-prompt" | "/api/write/publish" | "/api/write/stats" | "/api/write/today" | "/api/write/today/action" | "/api/write/writings" | "/api/writing-card" | "/api/writings/save" | `/api/writings/${string}` & {} | `/api/writings/${string}/comments-toggle` & {} | `/api/writings/${string}/comments` & {} | "/audio" | `/card/${string}` & {} | "/confirmation-success" | "/confirm" | "/evaluate" | "/forgot-password" | "/games" | "/games/booty" | `/images/${string}` & {} | `/invite/${string}` & {} | "/login" | "/newsletter/confirm" | "/privacy" | "/profile" | "/refine" | "/reset-password" | "/reviews" | "/signup" | "/sitemap.xml" | "/terms" | "/test-secrets" | "/test-upload" | "/test-utf8" | "/write" | "/write/new" | `/write/${string}` & {} | "/writings" | `/writings/${string}` & {} | `/writings/${string}/edit` & {};
		ResolvedPathname(): `${"" | `/${string}`}${ReturnType<AppTypes['Pathname']>}`;
		Asset(): "/.assetsignore" | "/_routes.json" | "/favicon.ico" | "/robots.txt" | string & {};
	}
}