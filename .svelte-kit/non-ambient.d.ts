...
declare module "$app/types" {
	...
	export interface AppTypes {
		...
		LayoutParams(): {
			...
			"/admin/bottles": Record<string, never>;
			...
			"/api/ar": Record<string, never>;
			"/api/ar/portals": Record<string, never>;
			"/api/ar/portals/nearby": Record<string, never>;
			"/api/auth": { all?: string };
			...
			"/api/bottlequest/fiesta": Record<string, never>;
			"/api/bottlequest/fiesta/scores": Record<string, never>;
			...
			"/api/bottlequest/physical": Record<string, never>;
			"/api/bottlequest/physical/create": Record<string, never>;
			"/api/bottlequest/physical/generate": Record<string, never>;
			...
			"/games/booty/arbooty": Record<string, never>;
			"/games/booty/arbooty/create": Record<string, never>;
