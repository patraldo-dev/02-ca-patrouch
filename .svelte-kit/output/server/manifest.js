	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/auth/forgot-password/_server.js'))
			},
			{
				id: "/api/auth/login",
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/auth/reset-password/_server.js'))
			},
			{
				id: "/api/auth/signup",
