    ...
    if (playersWithDist().length) {
      ...
      for (let $$index_11 = 0, $$length = each_array_11.length; $$index_11 < $$length; $$index_11++) {
        ...
        if (player.nearestDist !== null) {
          $$renderer2.push("<!--[0-->");
          $$renderer2.push(`<div class="detail-row svelte-1wyf3u8"><span class="svelte-1wyf3u8">🍾 Nearest</span><span class="svelte-1wyf3u8">${escape_html(player.nearestDist.toFixed(0))} km</span></div>`);
        } else {
          $$renderer2.push("<!--[-1-->");
        }
        $$renderer2.push(`<!--]--></div> `);
