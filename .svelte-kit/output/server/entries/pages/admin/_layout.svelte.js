import { h as head, a as attr_class, b as store_get, e as escape_html, u as unsubscribe_stores } from "../../../chunks/renderer.js";
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    })}>📨 ${escape_html(store_get($$store_subs ??= {}, "$t", t)("pages.admin.layout.invitations"))}</a> <a href="/admin/bottles"${attr_class("svelte-1qg5d05", void 0, {
      "active": store_get($$store_subs ??= {}, "$page", page).url.pathname.startsWith("/admin/bottles")
    })}>🏴‍☠️ Bottles</a> <a href="/admin/analytics"${attr_class("svelte-1qg5d05", void 0, {
