import { h as head, e as escape_html, b as store_get, a as attr_class, f as ensure_array_like, u as unsubscribe_stores } from "../../../../chunks/renderer.js";
  ...
  $$renderer.component(($$renderer2) => {
    ...
    if (data.groups?.length > 0) {
      ...
      for (let $$index_1 = 0, $$length = each_array.length; $$index_1 < $$length; $$index_1++) {
        ...
        $$renderer2.push(`<section class="day-group svelte-1obznh"><h2 class="day-heading svelte-1obznh">${escape_html(formatDate(group.date))}</h2> <div class="prompt-quote svelte-1obznh"><span class="prompt-label svelte-1obznh">${escape_html(store_get($$store_subs ??= {}, "$t", t)("agora.community.prompt_label"))}</span> <p class="prompt-text svelte-1obznh">${escape_html(group.prompt)}</p></div> <div class="responses svelte-1obznh"><!--[-->`);
        const each_array_1 = ensure_array_like(group.writings);
        for (let $$index = 0, $$length2 = each_array_1.length; $$index < $$length2; $$index++) {
          let w = each_array_1[$$index];
          $$renderer2.push(`<article class="response-card svelte-1obznh"><div class="response-header svelte-1obznh"><span class="response-author svelte-1obznh">${escape_html(w.username)}</span> <span class="response-words svelte-1obznh">${escape_html(w.word_count)} ${escape_html(store_get($$store_subs ??= {}, "$t", t)("agora.words"))}</span> `);
          if (w.ai_assisted) {
            $$renderer2.push("<!--[0-->");
            $$renderer2.push(`<span class="ai-badge svelte-1obznh">${escape_html(store_get($$store_subs ??= {}, "$t", t)("agora.ai_assisted"))}</span>`);
          } else {
            $$renderer2.push("<!--[-1-->");
          }
          $$renderer2.push(`<!--]--></div> <h3 class="response-title svelte-1obznh">${escape_html(w.title)}</h3> <p class="response-excerpt svelte-1obznh">${escape_html(excerpt(w.content))}</p></article>`);
        }
      ...
      $$renderer2.push("<!--[-1-->");
      $$renderer2.push(`<div class="empty-state svelte-1obznh"><p>${escape_html(store_get($$store_subs ??= {}, "$t", t)("agora.community.no_responses"))}</p></div>`);
    }
    $$renderer2.push(`<!--]--></div>`);
