	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				pattern: /^\/api\/account\/reset-password\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/account/reset-password/_server.js'))
			},
			{
				id: "/api/admin",
				pattern: /^\/api\/admin\/?$/,
			...
			{
				id: "/api/admin/bottles",
				pattern: /^\/api\/admin\/bottles\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/admin/bottles/_server.js'))
			},
			{
