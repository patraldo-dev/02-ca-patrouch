...
const COAST_POINTS = [
    // Bay of Banderas — dense coverage for precision
    [20.71, -105.54, 0.1], [20.72, -105.50, 0.1], [20.72, -105.45, 0.1],
    [20.72, -105.40, 0.1], [20.72, -105.35, 0.1], [20.72, -105.29, 0.1],
    [20.70, -105.55, 0.1], [20.68, -105.50, 0.1], [20.67, -105.45, 0.1],
    [20.66, -105.40, 0.1], [20.65, -105.35, 0.1], [20.65, -105.30, 0.1],
    ...
    [19.5, -105.0, 0.3], [19.1, -104.5, 0.3],
    [18.0, -103.5, 0.4], [16.5, -99.5, 0.4], [15.5, -96.0, 0.4],
    [15.0, -93.0, 0.4],
    // Central America
    [12.0, -87.0, 0.4], [9.0, -80, 0.5],
    // South America
    [4.0, -77.5, 0.5], [-1.5, -80.0, 0.5], [-10, -78, 0.5], [-25, -71, 0.5],
    // Baja California
    [28, -114, 0.5], [24, -110, 0.5], [23, -110, 0.5], [28, -115.5, 0.8],
    // Islands
    [20.8, -156.5, 0.3], [-0.7, -90.5, 0.2], [10.3, -109.2, 0.1], [18.7, -112, 0.3],
    // US/Canada
    [48, -125, 0.5], [37, -122, 0.3],
];
