...
const descriptions = {
    'en': {
        '/': 'Patrouch — A Playful Space for Serious Writing. Get daily creative sparks, write in any language, and share your voice with a community of writers.',
        ...
        '/signup': 'Join Patrouch — a playful space for serious writing. Get daily sparks and start writing today.',
    },
    'es': {
        '/': 'Patrouch — Un Espacio Lúdico para Escritura Seria. Recibe chispas creativas diarias, escribe en cualquier idioma y comparte tu voz con una comunidad de escritores.',
        ...
        '/signup': 'Únete a Patrouch — un espacio lúdico para escritura seria. Recibe chispas diarias y empieza a escribir hoy.',
    },
    'fr': {
        '/': 'Patrouch — Un Espace Ludique pour l\'Écriture Sérieuse. Recevez des étincelles créatives quotidiennes, écrivez dans n\'importe quelle langue et partagez votre voix.',
        ...
        '/signup': 'Rejoignez Patrouch — un espace ludique pour l\'écriture sérieuse. Recevez des étincelles quotidiennes et commencez à écrire.',
    }
};
