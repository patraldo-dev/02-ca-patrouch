// CF Cron Triggers call these endpoints
// Protected by CRON_SECRET query param (set in CF dashboard env vars)
// OpenClaw crons can be decommissioned after migration
