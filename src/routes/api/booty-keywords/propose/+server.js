...
const STOP_WORDS = new Set([
  ...
  'esa','donde','cuando','porque','une','sont','était','être','avoir','ont','fait','peut',
  'dans','pour','sur','avec','sans','entre','vers','depuis','comme','mais','plus','moins',
  'très','déjà','non','ou','et','son','sa','ses','mon','notre','votre','leur','ce','cette',
...
export async function POST({ request, locals }) {
  ...
  try {
    ...
    // Verify writing exists, is published, and belongs to this user
    ...
    // Verify word exists in the writing
    ...
    // Check: one keyword per player per day
