...
export async function POST({ request, platform, locals }) {
    ...
    try {
        ...
        const systems = {
            ...
            'en-es-fr': `You are a multilingual literary editor fluent in English, Spanish, and French. The text below may contain any combination of these three languages — code-switching, multilingual prose, or translation play. You MUST base your analysis ONLY on the text provided. Do NOT invent or fabricate. Quote exact words preserving the original language. This is raw, unrevised stream-of-consciousness prose. Find where a genuine authorial voice emerges across all languages present. Quote each moment exactly (preserving original language), explain what works, rate 1-10. Score: Vocabulary richness (across all languages), Structural intent, Emotional impact, Originality, Craft (each 1-10). Overall score 1-100. Respond in the language(s) most present in the text.`
        };
        ...
        const labels = {
            ...
            'en-es-fr': 'TEXT TO EVALUATE (English/Spanish/French)'
        };
