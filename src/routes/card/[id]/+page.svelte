<script>
    ...
    function shareTwitter() {
        const truncated = shareText.length > 200 ? shareText.slice(0, 200) + '…' : shareText;
        window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(truncated)}&url=${encodeURIComponent(shareUrl)}`, '_blank');
    }
...
<div class="card-container">
    ...
    <div class="actions">
        ...
        <div class="share-buttons">
            ...
            <button class="share-btn twitter" onclick={shareTwitter} title="Share on X / Twitter">
