...
<script>
    ...
    let isAutoGenerated = $state(true);
    ...
    <form onsubmit={(e) => { e.preventDefault(); handleSignup(); }}>
        ...
        <div>
            ...
            <div class="password-row">
                <input id="password" bind:value={password} type={showPassword ? 'text' : 'password'} placeholder={$t('signup.password_placeholder')} required minlength="8" autocomplete="new-password" disabled={isLoading} oninput={() => { isAutoGenerated = false; confirmPassword = ''; }} />
                ...
                <button type="button" class="btn-generate" title="Generate password" onclick={() => { const p = generatePassword(); password = p; confirmPassword = p; isAutoGenerated = true; }} disabled={isLoading}>🔄</button>
            </div>
        </div>
        {#if !isAutoGenerated}
        <div>
